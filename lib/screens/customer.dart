                              ...
                              children: <Widget>[
                                Expanded(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      color:
                                          vronly ? Colors.grey : Colors.white,
                                    ),
                                  ),
                                ),
                                Expanded(
                      ...
                      return snapshot.hasData
                          ? ListView.builder(
                              ...
                              itemBuilder: (BuildContext cntext, int index) {
                                ...
                                _pocinactivecontrollers[index].text = snapshot
                                    .data.pocs[index].inactive
                                    .toString();
                                _pocmaincontrollers[index].text = snapshot
                                    .data.pocs[index].mainpoc
                                    .toString();
                                ...
                                _pocrrncontrollers[index].text = snapshot
                                    ...
                                    .toString();
                                _poccompcontrollers[index].text = snapshot
                                    .data.pocs[index].company
                                    .toString();
                                  ...
                                  child: ExpansionTile(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Row(
                                            children: <Widget>[
                                              Text('Inactive: '),
                                              Checkbox(value: _pocinactivecontrollers[index].text == 'true',),
                                            ],
                                          ),
                                        ),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          alignment: al,
                                          child: Text('Connection Contact: ' +
                                              _poccccontrollers[index].text),
                                        ),
                                      ),
                                      Container(
                                        padding: EdgeInsets.all(4),
                                        child: Align(
                                          ...
                                          child: Text('Mandatory CC: ' +
                                              _pocmandcontrollers[index].text),
                                        ),
                                      ),
                                      Container(
                                        padding: EdgeInsets.all(4),
                                      ...
                                      Container(
                                        ...
                                        child: Align(
                                          alignment: al,
                                          child: Text('Customer: ' +
                                              _poccustcontrollers[index].text),
                                        ),
                                      ),
                                      Container(
                                        padding: EdgeInsets.all(4),
