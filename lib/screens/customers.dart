...
class _CustomersPageState extends State<CustomersPage> {
                ...
                return GestureDetector(
                    onTap: (){
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                CustomerEntry(title: snapshot.data.customers[index].customername, customer: snapshot.data.customers[index])),
                      );

                    },
                    child: Card(
                      child: ListTile(
                        title: Text(snapshot.data.customers[index].customerid.toString() + " - " + snapshot.data.customers[index].customername.toString()),
                      ),
                    )
                );
              },
  ...
  Future<CustomerList> loadCustomerList() async{
    print('func called');
    String jsonString =
    await DefaultAssetBundle.of(context).loadString("assets/customerdata.json");
